...
CREATE TABLE "singer" ("Singer_ID" int,"Name" text,"Country" text,"Song_Name" text,"Song_release_year" text,"Birthday" TIMESTAMP,"Is_male" bool,PRIMARY KEY ("Singer_ID"));



INSERT INTO  "singer" VALUES (1,"Joe Sharp","Netherlands","You","1992",'1971-02-09 00:00:00',"F");
INSERT INTO  "singer" VALUES (2,"Timbaland","United States","Dangerous","2008",'1989-02-19 00:00:00',"T");
INSERT INTO  "singer" VALUES (3,"Justin Brown","France","Hey Oh","2013",'1992-12-09 00:00:00',"T");
INSERT INTO  "singer" VALUES (4,"Rose White","France","Sun","2003",'1981-03-03 00:00:00',"F");
INSERT INTO  "singer" VALUES (5,"John Nizinik","France","Gentleman","2014",'1970-05-09 00:00:00',"T");
INSERT INTO  "singer" VALUES (6,"Tribal King","France","Love","2016",'1996-12-29 00:00:00',"T");


CREATE TABLE "concert" ("concert_ID" int,"concert_Name" text,"Theme" text,"Stadium_ID" text,"Year" text,PRIMARY KEY ("concert_ID"),FOREIGN KEY ("Stadium_ID") REFERENCES "stadium"("Stadium_ID"));
...
CREATE TABLE "singer_in_concert" ("concert_ID" int,"Singer_ID" text,PRIMARY KEY ("concert_ID","Singer_ID"),FOREIGN KEY ("concert_ID") REFERENCES "concert"("concert_ID"),FOREIGN KEY ("Singer_ID") REFERENCES "singer"("Singer_ID"));
